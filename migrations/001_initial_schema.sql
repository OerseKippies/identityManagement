-- idM initial schema (MariaDB 10.6)
...
CREATE TABLE IF NOT EXISTS idm_roles (
    ...
    createdAt DATETIME NOT NULL,
    updatedAt DATETIME NOT NULL,
    UNIQUE KEY uq_idm_roles_role_code (roleCode),
...
CREATE TABLE IF NOT EXISTS idm_permissions (
    ...
    createdAt DATETIME NOT NULL,
    updatedAt DATETIME NOT NULL,
    UNIQUE KEY uq_idm_permissions_permission_code (permissionCode),
    KEY idx_idm_permissions_status (status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS idm_user_roles (
    userRoleId CHAR(36) NOT NULL PRIMARY KEY,
    ...
    KEY idx_idm_user_roles_user (userId),
    KEY idx_idm_user_roles_role (roleId)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS idm_role_permissions (
    rolePermissionId CHAR(36) NOT NULL PRIMARY KEY,
    roleId CHAR(36) NOT NULL,
    ...
    KEY idx_idm_role_permissions_role (roleId),
    KEY idx_idm_role_permissions_permission (permissionId)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS idm_service_accounts (
    serviceAccountId CHAR(36) NOT NULL PRIMARY KEY,
    accountName VARCHAR(160) NOT NULL,
    description TEXT NULL,
    status VARCHAR(24) NOT NULL,
    createdAt DATETIME NOT NULL,
    updatedAt DATETIME NOT NULL,
    UNIQUE KEY uq_idm_service_accounts_account_name (accountName),
    KEY idx_idm_service_accounts_status (status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS idm_service_account_roles (
    serviceAccountRoleId CHAR(36) NOT NULL PRIMARY KEY,
    ...
    KEY idx_idm_service_account_roles_account (serviceAccountId),
    KEY idx_idm_service_account_roles_role (roleId)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS idm_access_policies (
    ...
    createdAt DATETIME NOT NULL,
    updatedAt DATETIME NOT NULL,
    UNIQUE KEY uq_idm_access_policies_policy_code (policyCode),
    KEY idx_idm_access_policies_status (status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS idm_token_references (
    tokenReferenceId CHAR(36) NOT NULL PRIMARY KEY,
    ...
    KEY idx_idm_token_references_expires (expiresAt)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS idm_audit_log (
    ...
    KEY idx_idm_audit_log_correlation (correlationId)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
